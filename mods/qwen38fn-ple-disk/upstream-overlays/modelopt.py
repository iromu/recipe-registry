    ...
    def get_quant_method(
        ...
        if isinstance(layer, RoutedExperts):
            ...
            if quant_algo in ("FP8_BLOCK_SCALES", "FP8_BLOCK", "FP8_PB_WO"):
                # Kai/2Wild 2026-09-05/06: NVIDIA's Qwen3.8-Flash-Next-NVFP4 stores the MTP
                # routed experts as 128x128 block-scaled FP8 (weight_scale_inv; quant_algo
                # "FP8_PB_WO" in this checkpoint). The mixed config had no branch for it;
                # route to vLLM's generic block-FP8 MoE method.
